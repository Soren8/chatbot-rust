...
def chat():
    ...
    logger.info(f"Received chat request. Session: {session_id} | Message: {user_message[:50]}...")
...
def regenerate():
    ...
    logger.info(f"Received regenerate request. Session: {session_id} | Message: {user_message[:50]}...")
