...
- **Configuration & Secrets**
  ...
  - [x] CodeQL security scanning enabled in the GitHub repo (Settings → Code security → CodeQL). Alerts appear under the Security tab; no in-repo workflow required when using GitHub’s default setup.
