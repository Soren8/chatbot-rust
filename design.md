...
**Current Refactor Trail:** For the ongoing Python-to-Rust refactor, review `temp/rust-refactor.md` for guiding principles and the latest checklist before making related changes.
