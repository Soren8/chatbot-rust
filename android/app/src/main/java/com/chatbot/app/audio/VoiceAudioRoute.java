...
/**
 * Holds Android communication ("call speaker") routing for one voice-mode session.
 *
 * {@link #enter} is a no-op if already active so TTS start/stop cannot flip
 * {@link AudioManager#MODE_IN_COMMUNICATION} or speakerphone mid-utterance.
 */
public final class VoiceAudioRoute {
    ...
    /**
     * Apply call routing once. Returns false when already active or {@code backend} is null
